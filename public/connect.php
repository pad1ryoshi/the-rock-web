...
if ($_SESSION["user_type"] == "new") {
    ...
    mysqli_query($con,"INSERT INTO `$table_name` (firstname, lastname, email, mac, last_updated, celular, estado, cidade, profissao) VALUES ('$fname', '$lname', '$email', '$clientMac', '$celular', '$estado', '$cidade', '$profissao', NOW())");
}
